...
Secondly there is a partial storage layer included on this platform. This is because many of the supported stores use synchronous HTTP and this is not supported on these platforms, most stores that require HTTP are accessible via the new [[http://www.dotnetrdf.org/api/index.asp?Topic=VDS.RDF.Storage.IAsyncStorageProvider|IAsyncStorageProvider]] API instead.
