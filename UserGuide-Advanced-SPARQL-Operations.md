...
If you are configuring a SPARQL endpoint via our [[Configuration API|UserGuide-Configuration-API]] you can configure the Query Optimiser to use via the `dnr:queryOptimiser` property. See [[HTTP Handlers|UserGuide-Configuration-HTTP-Handlers]] and [[Configuration API - Optimizers|UserGuide-Configuration-SPARQL-Optimisers]] for details on how to do this.
...
If you are configuring a SPARQL endpoint via our [[Configuration API|UserGuide-Configuration-API]] you can configure the Algebra Optimisers to use via the `dnr:algebraOptimiser` property. See [[Configuration API - HTTP Handlers|UserGuide/Configuration/HTTP Handlers]] and [[Configuration API - Optimizers|UserGuide-Configuration-SPARQL-Optimisers]] for details on how to do this.
