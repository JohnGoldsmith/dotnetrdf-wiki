[[Home]] > [[User Guide]] > [[UserGuide/Exceptions|Exceptions]]
...
* [[http://www.dotnetrdf.org/api/index.asp?Topic=VDS.RDF.RdfException|RdfException]]
** [[http://www.dotnetrdf.org/api/index.asp?Topic=VDS.RDF.Configuration.DotNetRdfConfigurationException|DotNetRdfConfigurationException]]
** [[http://www.dotnetrdf.org/api/index.asp?Topic=VDS.RDF.Parsing.RdfParseException|RdfParseException]]
*** [[http://www.dotnetrdf.org/api/index.asp?Topic=VDS.RDF.Parsing.RdfParserSelectionException|RdfParserSelectionException]]
** [[http://www.dotnetrdf.org/api/index.asp?Topic=VDS.RDF.Query.RdfQueryException|RdfQueryException]]
*** [[http://www.dotnetrdf.org/api/index.asp?Topic=VDS.RDF.Query.RdfQueryTimeoutException|RdfQueryTimeoutException]]
** [[http://www.dotnetrdf.org/api/index.asp?Topic=VDS.RDF.Storage.RdfStorageException|RdfStorageException]]
** [[http://www.dotnetrdf.org/api/index.asp?Topic=VDS.RDF.Update.SparqlUpdateException|SparqlUpdateException]]
** [[http://www.dotnetrdf.org/api/index.asp?Topic=VDS.RDF.Writing.RdfOutputException|RdfOutputException]]
*** [[http://www.dotnetrdf.org/api/index.asp?Topic=VDS.RDF.Writing.RdfWriterSelectionException|RdfWriterSelectionException]]
...
The ##DotNetRdfConfigurationException## is an exception that may occur when utilizing the [[UserGuide/Configuration API|Configuration API]].  Typically it occurs due to malformed configuration information.
